...
* Ruby >= 2.1.0
* OPUS Audio Codec
* Murmur server > 1.2.4 -- NOTE: mumble-ruby will not connect to servers that don't support OPUS anymore. I haven't looked into backwards-compatability with CELT.
